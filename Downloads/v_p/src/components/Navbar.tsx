      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <a
                href="/Vaamanan_Resume.pdf"
                download="Vaamanan_Mugunthan_Resume.pdf"
          ...
          <div className="md:hidden py-4 border-t border-border">
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" size="sm" className="w-full mt-2 gap-2" asChild>
                <a href="/Vaamanan_Resume.pdf" download="Vaamanan_Mugunthan_Resume.pdf" aria-label="Download Resume">
                  <Download className="h-4 w-4" />
                  Download Resume
                </a>
              </Button>
